...
public class Player_Punch : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Player 1 punch
        if (Input.GetKeyDown(KeyCode.J) && reloadTime >= 0.5)
        {
            //Minus mana
        ...
        if (Input.GetKeyDown(KeyCode.K) && reloadTime >= 0.5)
        {
            //Minus mana
        ...
        if (Input.GetKeyDown(KeyCode.L) && reloadTime >= 0.5)
        {
            //Minus mana
            //ManageHealth.Manage_Mana(1, -7.5f);
        ...
        //Player 2 punch
        if (Input.GetKeyDown(KeyCode.Keypad1) && reloadTime >= 0.5)
        {
            //Minus mana
        ...
        if (Input.GetKeyDown(KeyCode.Keypad2) && reloadTime >= 0.5)
        {
            //Minus mana
